...
def get_args():
    ...
    parser.add_argument(
        ...
        default=f"{KWS_DIR}/encoder-epoch-12-avg-2-chunk-16-left-64.onnx",
    )
    ...
    parser.add_argument(
        ...
        default=f"{KWS_DIR}/decoder-epoch-12-avg-2-chunk-16-left-64.onnx",
    )
    ...
    parser.add_argument(
        ...
        default=f"{KWS_DIR}/joiner-epoch-12-avg-2-chunk-16-left-64.onnx",
    )
    ...
    parser.add_argument(
        ...
        x iǎo ài t óng x ué 
        """,
        default=f"{KWS_DIR}/keywords.txt",
    )
